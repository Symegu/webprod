...
},{"./main.js":"bDbGG","../style.css":"dRy26"}],"bDbGG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _datecalcJs = require("./datecalc.js");
var _utilsJs = require("./utils.js");
var _timerJs = require("./timer.js");
var _timerJsDefault = parcelHelpers.interopDefault(_timerJs);
var _switcherJs = require("./switcher.js");
...
function handleCalcDates(event) {
    ...
    if (firstDate && secondDate) {
        const diff = (0, _datecalcJs.diffDates)(firstDate, secondDate);
        dateCalcResult.innerHTML = (0, _datecalcJs.diffToHtml)(diff);
    } else dateCalcResult.innerHTML = (0, _utilsJs.formatError)("\u0414\u043B\u044F \u0440\u0430\u0441\u0447\u0435\u0442\u0430 \u043F\u0440\u043E\u043C\u0435\u0436\u0443\u0442\u043A\u0430 \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u043E \u0437\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u044C \u043E\u0431\u0430 \u043F\u043E\u043B\u044F");
}
...
startBtn.addEventListener("click", function(event) {
    ...
    (0, _timerJsDefault.default)(timerMinute);
});
stopBtn.addEventListener("click", function(event) {
    event.preventDefault();
    console.log("stop");
    clearInterval((0, _timerJsDefault.default));
});

},{"./datecalc.js":"6eZqR","./utils.js":"eYK4L","./timer.js":"b7mcv","./switcher.js":"kmZJ2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6eZqR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "diffDates", ()=>diffDates);
parcelHelpers.export(exports, "diffToHtml", ()=>diffToHtml);
var _esmJs = require("../esm.js"); // 1
function diffDates(firstDate, secondDate) {
    var _firstDate;
    firstDate = (0, _esmJs.DateTime).fromISO(firstDate);
    secondDate = (0, _esmJs.DateTime).fromISO(secondDate);
    if (firstDate > secondDate) secondDate = (_firstDate = firstDate, firstDate = secondDate, _firstDate); // 2
...
},{"../esm.js":"kUT9E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kUT9E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function padStart(input, n2 = 2) {
    if (input.toString().length < n2) return ("0".repeat(n2) + input).slice(-n2);
...
function formatOffset(offset1, format) {
    const hours = Math.trunc(offset1 / 60), minutes = Math.abs(offset1 % 60), sign = hours >= 0 && !Object.is(hours, -0) ? "+" : "-", base = `${sign}${Math.abs(hours)}`;
    switch(format){
        case "short":
...
function stringifyTokens(splits, tokenToString) {
    let s1 = "";
    for (const token of splits)if (token.literal) s1 += token.val;
 ...
 */ class Formatter {
    ...
    num(n3, p = 0) {
        ...
        if (this.opts.forceSimple) return padStart(n3, p);
        const opts = Object.assign({}, this.opts);
        if (p > 0) opts.padTo = p;
        return this.loc.numberFormatter(opts).format(n3);
    }
    formatDateTimeFromString(dt, fmt) {
        const knownEnglish = this.loc.listingMode() === "en", useDateTimeFormatter = this.loc.outputCalendar && this.loc.outputCalendar !== "gregory" && hasFormatToParts(), string = (opts, extract)=>this.loc.extract(dt, opts, extract), formatOffset1 = (opts)=>{
...
function extractISOTime(match5, cursor) {
    const item = {
        hour: int(match5, cursor, 0),
        minute: int(match5, cursor + 1, 0),
        second: int(match5, cursor + 2, 0),
 ...
 */ class Duration {
   ...
   */ toISO() {
        ...
        s12 += roundTo(this.seconds + this.milliseconds / 1000, 3) + "S";
        if (s12 === "P") s12 += "T0S";
        return s12;
    }
    /**
 ...
 */ class Interval {
   ...
   */ static fromISO(text, opts) {
        ...
        if (s13 && e) {
            const start = DateTime.fromISO(s13, opts), end = DateTime.fromISO(e, opts);
   ...
   */ intersection(other) {
        ...
        if (s16 > e) return null;
        else return Interval.fromDateTimes(s16, e);
    }
    /**
...
function stripInsensitivities(s20) {
    return s20.replace(/\./, "").toLowerCase();
}
...
},{}],"eYK4L":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b7mcv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kmZJ2":[function(require,module,exports) {
...
},{}],"dRy26":[function() {},{}]},["4lTDk","1Z4Rq"], "1Z4Rq", "parcelRequirec460")
